import 'package:equatable/equatable.dart';import 'package:flutter/material.dart';import '/core/app_export.dart';import '../models/listmusic_item_model.dart';import 'package:basri_s_application10/presentation/video_editing_tools_screen/models/video_editing_tools_model.dart';part 'video_editing_tools_event.dart';part 'video_editing_tools_state.dart';class VideoEditingToolsBloc extends Bloc<VideoEditingToolsEvent, VideoEditingToolsState> {VideoEditingToolsBloc(VideoEditingToolsState initialState) : super(initialState) { on<VideoEditingToolsInitialEvent>(_onInitialize); on<ChangeCheckBoxEvent>(_changeCheckBox); }
