import 'package:equatable/equatable.dart';import 'package:flutter/material.dart';import '/core/app_export.dart';import '../models/videotrimming_item_model.dart';import 'package:basri_s_application10/presentation/video_trimming_screen/models/video_trimming_model.dart';part 'video_trimming_event.dart';part 'video_trimming_state.dart';class VideoTrimmingBloc extends Bloc<VideoTrimmingEvent, VideoTrimmingState> {VideoTrimmingBloc(VideoTrimmingState initialState) : super(initialState) { on<VideoTrimmingInitialEvent>(_onInitialize); on<ChangeCheckBoxEvent>(_changeCheckBox); }
