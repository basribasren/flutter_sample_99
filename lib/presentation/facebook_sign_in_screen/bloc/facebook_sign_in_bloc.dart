import 'package:equatable/equatable.dart';import 'package:flutter/material.dart';import '/core/app_export.dart';import 'package:basri_s_application10/presentation/facebook_sign_in_screen/models/facebook_sign_in_model.dart';part 'facebook_sign_in_event.dart';part 'facebook_sign_in_state.dart';class FacebookSignInBloc extends Bloc<FacebookSignInEvent, FacebookSignInState> {FacebookSignInBloc(FacebookSignInState initialState) : super(initialState) { on<FacebookSignInInitialEvent>(_onInitialize); on<ChangePasswordVisibilityEvent>(_changePasswordVisibility); on<ChangeCheckBoxEvent>(_changeCheckBox); }
