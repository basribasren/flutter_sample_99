import 'package:equatable/equatable.dart';import 'package:flutter/material.dart';import '/core/app_export.dart';import '../models/videolibrary_item_model.dart';import 'package:basri_s_application10/presentation/video_library_screen/models/video_library_model.dart';part 'video_library_event.dart';part 'video_library_state.dart';class VideoLibraryBloc extends Bloc<VideoLibraryEvent, VideoLibraryState> {VideoLibraryBloc(VideoLibraryState initialState) : super(initialState) { on<VideoLibraryInitialEvent>(_onInitialize); on<ChangeDropDownEvent>(_changeDropDown); }
