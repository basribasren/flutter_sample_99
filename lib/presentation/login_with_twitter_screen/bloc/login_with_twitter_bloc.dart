import 'package:equatable/equatable.dart';import 'package:flutter/material.dart';import '/core/app_export.dart';import 'package:basri_s_application10/presentation/login_with_twitter_screen/models/login_with_twitter_model.dart';part 'login_with_twitter_event.dart';part 'login_with_twitter_state.dart';class LoginWithTwitterBloc extends Bloc<LoginWithTwitterEvent, LoginWithTwitterState> {LoginWithTwitterBloc(LoginWithTwitterState initialState) : super(initialState) { on<LoginWithTwitterInitialEvent>(_onInitialize); on<ChangePasswordVisibilityEvent>(_changePasswordVisibility); on<ChangeCheckBoxEvent>(_changeCheckBox); }
