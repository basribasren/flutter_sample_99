...
import 'package:basri_s_application10/widgets/custom_text_form_field.dart';
import 'package:flutter/material.dart';

class CaptchaScreen extends StatelessWidget {
  static Widget builder(BuildContext context) {
    return BlocProvider<CaptchaBloc>(
      create: (context) => CaptchaBloc(CaptchaState(
        captchaModelObj: CaptchaModel(),
      ))
        ..add(CaptchaInitialEvent()),
      child: CaptchaScreen(),
    );
  }
              ...
              Container(
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      BlocSelector<CaptchaBloc, CaptchaState,
                          TextEditingController?>(
                        selector: (state) => state.group10033Controller,
                        builder: (context, group10033Controller) {
                          return CustomTextFormField(
                            focusNode: FocusNode(),
                            controller: group10033Controller,
                            hintText: "msg_select_all_images".tr,
                            margin: getMargin(
                              top: 1,
                            ),
