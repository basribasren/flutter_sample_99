import 'package:equatable/equatable.dart';import 'package:flutter/material.dart';import '/core/app_export.dart';import 'package:basri_s_application10/presentation/content_moderation_dialog/models/content_moderation_model.dart';part 'content_moderation_event.dart';part 'content_moderation_state.dart';class ContentModerationBloc extends Bloc<ContentModerationEvent, ContentModerationState> {ContentModerationBloc(ContentModerationState initialState) : super(initialState) { on<ContentModerationInitialEvent>(_onInitialize); on<ChangeRadioButtonEvent>(_changeRadioButton); }
