import 'package:equatable/equatable.dart';import 'package:flutter/material.dart';import '/core/app_export.dart';import '../models/sorting_item_model.dart';import 'package:basri_s_application10/presentation/sorting_screen/models/sorting_model.dart';part 'sorting_event.dart';part 'sorting_state.dart';class SortingBloc extends Bloc<SortingEvent, SortingState> {SortingBloc(SortingState initialState) : super(initialState) { on<SortingInitialEvent>(_onInitialize); on<ChangeDropDownEvent>(_changeDropDown); }
