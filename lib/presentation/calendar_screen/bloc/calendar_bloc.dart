import 'package:equatable/equatable.dart';import 'package:flutter/material.dart';import '/core/app_export.dart';import '../models/listmon_item_model.dart';import '../models/listovalcopytwo_item_model.dart';import 'package:basri_s_application10/presentation/calendar_screen/models/calendar_model.dart';part 'calendar_event.dart';part 'calendar_state.dart';class CalendarBloc extends Bloc<CalendarEvent, CalendarState> {CalendarBloc(CalendarState initialState) : super(initialState) { on<CalendarInitialEvent>(_onInitialize); }
