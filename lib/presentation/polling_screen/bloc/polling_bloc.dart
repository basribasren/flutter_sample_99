import 'package:equatable/equatable.dart';import 'package:flutter/material.dart';import '/core/app_export.dart';import 'package:basri_s_application10/presentation/polling_screen/models/polling_model.dart';part 'polling_event.dart';part 'polling_state.dart';class PollingBloc extends Bloc<PollingEvent, PollingState> {PollingBloc(PollingState initialState) : super(initialState) { on<PollingInitialEvent>(_onInitialize); on<ChangeRadioButtonEvent>(_changeRadioButton); }
