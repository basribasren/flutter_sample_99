import 'package:equatable/equatable.dart';import 'package:flutter/material.dart';import '/core/app_export.dart';import 'package:basri_s_application10/presentation/security_policy_screen/models/security_policy_model.dart';part 'security_policy_event.dart';part 'security_policy_state.dart';class SecurityPolicyBloc extends Bloc<SecurityPolicyEvent, SecurityPolicyState> {SecurityPolicyBloc(SecurityPolicyState initialState) : super(initialState) { on<SecurityPolicyInitialEvent>(_onInitialize); on<ChangePasswordVisibilityEvent>(_changePasswordVisibility); }
