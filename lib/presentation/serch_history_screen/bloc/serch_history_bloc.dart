import 'package:equatable/equatable.dart';import 'package:flutter/material.dart';import '/core/app_export.dart';import '../models/listgroup9695_item_model.dart';import '../models/list_item_model.dart';import 'package:basri_s_application10/presentation/serch_history_screen/models/serch_history_model.dart';part 'serch_history_event.dart';part 'serch_history_state.dart';class SerchHistoryBloc extends Bloc<SerchHistoryEvent, SerchHistoryState> {SerchHistoryBloc(SerchHistoryState initialState) : super(initialState) { on<SerchHistoryInitialEvent>(_onInitialize); }
