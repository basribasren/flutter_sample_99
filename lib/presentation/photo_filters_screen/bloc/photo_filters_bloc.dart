import 'package:equatable/equatable.dart';import 'package:flutter/material.dart';import '/core/app_export.dart';import '../models/photofilters_item_model.dart';import 'package:basri_s_application10/presentation/photo_filters_screen/models/photo_filters_model.dart';part 'photo_filters_event.dart';part 'photo_filters_state.dart';class PhotoFiltersBloc extends Bloc<PhotoFiltersEvent, PhotoFiltersState> {PhotoFiltersBloc(PhotoFiltersState initialState) : super(initialState) { on<PhotoFiltersInitialEvent>(_onInitialize); on<ChangeCheckBoxEvent>(_changeCheckBox); }
